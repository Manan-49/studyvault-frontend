    ...
    >
      ...
      <Link href="/explore">
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800"
        >
          <Home className="h-4 w-4 text-blue-600 dark:text-blue-400" />
          <span className="font-medium text-gray-900 dark:text-white">Root</span>
        </motion.div>
      </Link>
