        ...
        {actions.map((action, index) => (
          ...
          >
            <Link href={action.href} className="block w-full">
              <div className="group relative w-full overflow-hidden rounded-lg border border-border p-3 transition-all hover:border-transparent hover:shadow-lg sm:rounded-xl sm:p-4">
                ...
                <div className="relative flex flex-col items-center gap-1.5 text-center sm:gap-2">
                  ...
                  <span className="text-[11px] font-medium leading-tight text-muted-foreground transition-colors group-hover:text-white sm:text-sm">
                    {action.name}
                  </span>
                </div>
              </div>
